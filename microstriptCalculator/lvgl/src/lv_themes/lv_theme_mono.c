...
static void basic_init(void)
{
    ...
    bg.body.border.color = LV_COLOR_BLACK;
...
static void btn_init(void)
{
    ...
    btn_rel.body.border.color   = LV_COLOR_TRANSP;
...
static void btnm_init(void)
{
    ...
    btnm_bg.body.border.color = LV_COLOR_TRANSP;
    btnm_bg.body.border.opa   = LV_OPA_TRANSP;
    ...
    btnm_trel.body.border.color = lv_color_hsv_to_rgb(0, 0, 0);
    btnm_trel.body.border.width = 0;
...
static void list_init(void)
{
    ...
    list_rel.body.border.color = LV_COLOR_BLACK;
